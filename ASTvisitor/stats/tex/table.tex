...
\hline
env &  \textit{none} &C S a u\\ 
\hline
rm & INTERACTIVE\_OPTION PRESERVE\_ROOT &  \textit{none}\\ 
\hline
stdbuf &  \textit{none} &e i o\\ 
\hline
sort &  \textit{none} &S T batch-size compress-program files0-from k o parallel random-source sort t y\\ 
\hline
...
\hline
df &  \textit{none} &B F t x\\ 
\hline
paste &  \textit{none} &d\\ 
\hline
cut & OUTPUT\_DELIMITER\_OPTION & b c d f output-delimiter\\ 
\hline
ls &  \textit{none} &I T block-size format hide indicator-style quoting-style sort time time-style w\\ 
\hline
...
\hline
split &  \textit{none} &-io-blksize C a additional-suffix b filter l n t\\ 
\hline
